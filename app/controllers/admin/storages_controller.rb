...
class Admin::StoragesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Storage: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Storage: create, read, update, custom_action_for_an_item
  #
